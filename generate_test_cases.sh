...
# - Source is generated at yuv422p, then interlaced and finally converted to yuv420p.  Sunsampling in yuv420p may have sufficient vertical resolution in the chroma plane to feed the tinterlace filter.
